...
static const _DataAB_Request_type_support_symbol_names_t _DataAB_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, message, srv, DataAB_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, message, srv, DataAB_Request)),
  }
};
...
{
  return &::message::srv::rosidl_typesupport_cpp::DataAB_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, message, srv, DataAB_Request)() {
  return get_message_type_support_handle<message::srv::DataAB_Request>();
}
...
static const _DataAB_Response_type_support_symbol_names_t _DataAB_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, message, srv, DataAB_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, message, srv, DataAB_Response)),
  }
};
...
{
  return &::message::srv::rosidl_typesupport_cpp::DataAB_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, message, srv, DataAB_Response)() {
  return get_message_type_support_handle<message::srv::DataAB_Response>();
}
...
static const _DataAB_type_support_symbol_names_t _DataAB_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, message, srv, DataAB)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, message, srv, DataAB)),
  }
};
...
{
  return &::message::srv::rosidl_typesupport_cpp::DataAB_service_type_support_handle;
}
