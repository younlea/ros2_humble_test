...
#ifndef MESSAGE__SRV__DETAIL__DATA_AB__FUNCTIONS_H_
#define MESSAGE__SRV__DETAIL__DATA_AB__FUNCTIONS_H_
...
/// Create srv/DataAB message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * message__srv__DataAB_Request__init().
...
/// Destroy srv/DataAB message.
/**
 * It calls
 * message__srv__DataAB_Request__fini()
...
/// Check for srv/DataAB message equality.
/**
...
/// Initialize array of srv/DataAB messages.
/**
...
/// Finalize array of srv/DataAB messages.
/**
 * It calls
 * message__srv__DataAB_Request__fini()
...
/// Create array of srv/DataAB messages.
/**
 * It allocates the memory for the array and calls
 * message__srv__DataAB_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/DataAB messages.
/**
 * It calls
 * message__srv__DataAB_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/DataAB message array equality.
/**
...
/// Copy an array of srv/DataAB messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * message__srv__DataAB_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_message
...
/**
 * It calls
 * message__srv__DataAB_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_message
...
/**
 * It allocates the memory for the array and calls
 * message__srv__DataAB_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_message
...
/**
 * It calls
 * message__srv__DataAB_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MESSAGE__SRV__DETAIL__DATA_AB__FUNCTIONS_H_
